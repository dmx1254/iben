...
//         axios({
//           method: "post",
//           url: `${process.env.REACT_APP_CLIENT_URL}/pay-with-crypto/getcurrencybtccrypto`,
...
//       await axios
//         .get(`${process.env.REACT_APP_CLIENT_URL}/pay-with-crypto/btc`)
...
//       await axios
//         .get(`${process.env.REACT_APP_CLIENT_URL}/pay-with-crypto/btcqrcode`)
//         .then((res) => {
...
//             {valueCurrencyConvert?.value_coin} TRC20_BTC
//           </span>
